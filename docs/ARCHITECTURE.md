...
Registrierte Sync-Anbieter (SSOT): `ProviderID.syncProviderIDs` — Check24, Opodo, Booking.com, Airbnb, GetYourGuide, Traveloka, billiger-mietwagen, Expedia. Wiring in `ProviderSyncBootstrap.makeProviderRegistry()`.
