...
|---------------|------|----------|--------|
| `reisen-cloud` | `Application Support/Reisen/ReisenCloud.sqlite` | `.private(PersistenceBootstrap.cloudKitContainerID)` | Trips, Bookings, Gaps, Deadlines, Rates, Passengers, RoomItems, Baggage, AutoGapSuppress, **ProviderPreferences** |
...
>>>>>>> efcb644 (feat: iCloud-Sync in Einstellungen abwählbar)
