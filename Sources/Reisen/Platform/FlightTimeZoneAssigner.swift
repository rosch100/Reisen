...
@MainActor
final class FlightTimeZoneAssigner {
    ...
    init(bookingRepository: SwiftDataBookingRepository) {
        self.bookingRepository = bookingRepository
    }

    func assignMissingOffsets() async throws {
...
@MainActor
final class TimeNormalizationRepair {
    private let bookingRepository: SwiftDataBookingRepository
