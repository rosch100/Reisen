...
public enum ProviderLoginDisclosure {
    ...
    public static func localizedMessage(locale: Locale = .current) -> String {
        if locale.reisenPrefersGerman {
            return """
            Reisen ist nicht mit Booking.com, Airbnb, Check24, Opodo, GetYourGuide, Traveloka, billiger-mietwagen.de, Expedia.de oder anderen Anbietern verbunden oder von diesen unterstützt.
        ...
        return """
        Reisen is not affiliated with or endorsed by Booking.com, Airbnb, Check24, Opodo, GetYourGuide, Traveloka, billiger-mietwagen.de, Expedia.de, or other providers.
