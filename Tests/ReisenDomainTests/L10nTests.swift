...
@Test func l10n_deCopyClarity_terminologySSOT() {
    L10n.withLocale(Locale(identifier: "de")) {
        ...
        #expect(L10n.string(.menuSyncAllProviders) == "Alle aktualisieren")
        #expect(L10n.string(.menuSyncCurrentProvider) == "Aktuelles Portal aktualisieren")
        #expect(L10n.string(.menuSyncAllUnavailableHelp) == "Kein Portal bereit oder Synchronisation läuft")
        ...
        #expect(L10n.string(.syncSyncBookings) == "Buchungen aktualisieren")
