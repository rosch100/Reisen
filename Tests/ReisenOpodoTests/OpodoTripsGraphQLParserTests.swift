...
func opodoGraphQLParsesFlightAndHotel() throws {
    ...
    #expect(active.hotelOffsetSeconds == nil)
    let checkInEpoch = Date(timeIntervalSince1970: 1_787_270_400)
    let checkOutEpoch = Date(timeIntervalSince1970: 1_787_356_800)
    #expect(active.startAt == HotelStayDate.calendarDay(fromParsed: checkInEpoch))
    #expect(active.endAt == HotelStayDate.calendarDay(fromParsed: checkOutEpoch))
